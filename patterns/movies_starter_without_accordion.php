<?php
  /**
  * Title: Movie Two Columns Starter Without Accordion
  * Slug: layouts/movies_starter_without_accordions
...
<div class="wp-block-column movies-right-column"><!-- wp:cover {"url":"/wp-content/themes/tofu_blocks/patterns/images/load_screen.png","id":28,"dimRatio":70,"minHeight":100,"minHeightUnit":"vh","className":"movie-right-overlay"} -->
<div class="wp-block-cover movie-right-overlay" style="min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-70 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-28" alt="" src="/wp-content/themes/tofu_blocks/patterns/images/load_screen.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:image {"id":30,"sizeSlug":"full","linkDestination":"none","className":"img-opacity-3"} -->
<figure class="wp-block-image size-full img-opacity-3"><img src="/wp-content/themes/tofu_blocks/patterns/images/the_stranger.png" alt="" class="wp-image-30"/></figure>
<!-- /wp:image --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->